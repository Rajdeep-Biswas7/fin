    ...
    <div className="min-h-screen flex items-center justify-center px-4" style={{ background: "linear-gradient(135deg, #0f1117 0%, #161b27 100%)" }}>
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-sm mt-1" style={{ color: "#64748b" }}>Your AI-powered finance co-pilot</p>
        </div>

        <div className="card" style={{ background: "#161b27", border: "1px solid #1e2535", borderRadius: 16, padding: 32 }}>
          ...
          <p className="text-center text-sm mt-6" style={{ color: "#64748b" }}>
            ...
            <Link href="/register" style={{ color: "#22c55e" }} className="font-medium hover:underline">Create one</Link>
          </p>
        </div>
      </div>
    </div>
